...
[Layer 10 Bootstrap](/architecture/layer10-bootstrap) covers the cross-contract authority chain — including the OT-to-Futarchy atomic claim and the Futarchy-to-Multisig hand-off — plus the Scenario 2 E2E that drives all three proposal types (`MintOt`, `SpendTreasury`, `UpdateDestinations`) through propose, approve, and execute.
